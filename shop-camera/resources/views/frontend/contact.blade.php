                ...
                <div class="col">
                    <form action="" method="POST" role="form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="nhập tên vào đây">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="" class="form-control" name="phone" placeholder="nhập số điện thoại vào đây">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="text-center">
                            <button id="send" type="submit" class="btn btn-warning"><i class="fa fa-paper-plane"></i>Gửi</button>
                        </div>
                    </form>
                </div>
            </div>
