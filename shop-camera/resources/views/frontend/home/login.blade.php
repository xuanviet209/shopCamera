    ...
    <section class="py-5">
        <div class="container mt-5">
            ...
            <form method="POST" class="form" role="form">
                @csrf
                <input type="email" style="width:30%" name="email" class="form-control" placeholder="Email" required="required" />
                <p></p>
                <input type="password" style="width:30%" name="password" class="form-control" placeholder="Password" required="required" />
                <p></p>
                <button type="submit" style="width:30%" class="btn btn-warning btn-block btn-large">Log In</button>
            </form>
        </div>
    </section>
