                ...
                <div class="col">
                    <form action="" method="POST" role="form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ Auth::guard('cus')->user()->name }}">
                        </div>
                        <div class="mb-3">
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="password" value="{{ Auth::guard('cus')->user()->password }}">
                        </div> --}}
                        <div class="mb-3">
                        ...
                        <div class="text-center">
                            <button id="send" type="submit" class="btn btn-warning"><i class="fa fa-paper-plane"></i>Thay đổi</button>
                        </div>
                    </form>
                </div>
            </div>
