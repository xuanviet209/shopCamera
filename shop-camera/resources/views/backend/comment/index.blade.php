        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                @foreach ($comment as $key => $item)
                    <tr id="rowComment_{{ $item->comment_id }}">
                        <td>
                        ...
                        <td>{{ $item->comment }}
                            ...
                            @if ($item->comment_status == 0)
                                ...
                                <br><button class="btn btn-info btn-reply-comment"
    ...
    $('.btn-reply-comment').click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#notify_comment').html(
                    '<span class="text text-danger">Trả lời bình luận thành công</span>');
            }
        });
    });
